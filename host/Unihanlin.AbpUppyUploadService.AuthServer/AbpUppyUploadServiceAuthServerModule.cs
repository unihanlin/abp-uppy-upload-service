...
using Unihanlin.AbpUppyUploadService.MultiTenancy;
...
public class AbpUppyUploadServiceAuthServerModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("AbpUppyUploadService");
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                {"AbpUppyUploadService", "AbpUppyUploadService API"}
            },
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "AbpUppyUploadService API", Version = "v1" });
        ...
        {
            options.KeyPrefix = "AbpUppyUploadService:";
        });

        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("AbpUppyUploadService");
        if (!hostingEnvironment.IsDevelopment())
        {
            var redis = ConnectionMultiplexer.Connect(configuration["Redis:Configuration"]);
            dataProtectionBuilder.PersistKeysToStackExchangeRedis(redis, "AbpUppyUploadService-Protection-Keys");
        }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "AbpUppyUploadService API");
