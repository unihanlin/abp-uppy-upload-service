...
namespace Unihanlin.AbpUppyUploadService.Data;

public class AbpUppyUploadServiceTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<AbpUppyUploadServiceTenantDatabaseMigrationHandler> _logger;

    public AbpUppyUploadServiceTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<AbpUppyUploadServiceTenantDatabaseMigrationHandler> logger)
    {
